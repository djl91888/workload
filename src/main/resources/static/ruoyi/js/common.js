...
/** 创建选项卡 */
function createMenuItem(dataUrl, menuName,parentUrl) {
    ...
    var topWindow = $(window.parent.document);
	//选中左侧导航
	console.log($('#side-menu li',topWindow).length);
	if(parentUrl != '' && parentUrl != null && parentUrl != 'null' && parentUrl != undefined ){
		$('#side-menu li',topWindow).each(function(){
			console.log(dataUrl+'  aa  '+parentUrl);
			console.log($(this).find('a').attr('href'));
			if(parentUrl.includes($(this).find('a').attr('href'))){
